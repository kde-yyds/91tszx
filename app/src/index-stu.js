...
function createWindow() {
  ...
  // win.loadURL('https://prezy.91tszx.com/login?exetype=1') // 灰度
  // win.loadURL('https://zy.inside.chivoxapp.com/login?exetype=1') // 正式环境  学生客户端
  win.loadURL('https://91tszx.com/login?exetype=1') // 正式环境  学生客户端
